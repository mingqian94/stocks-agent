...
| 复盘时只看自己的收益率/排名，没对照大盘同期走势，容易误判 | ✅ 已改进 | 2026-07-30发现：12期收益比11期高(+3.87% vs +3.30%)排名却差很多(383 vs 68)——因为12期大盘本身涨了+3.44%，我们只是跟上大盘，"跑赢大盘的幅度"(excess_pct)只有+0.43%；11期大盘跌-0.82%，我们逆势+3.30%，跑赢+4.12%，这才是真正稀缺的表现。excess_pct跟排名的相关性比profit_pct本身更强（但也不是完美公式，17期反例见`periods_local.py`注释）。以后`periods_local.py`每期都顺手拿baostock查一下`sh.000300`同期涨跌幅，填上`market_pct`/`excess_pct`两个字段，复盘时对照着看，不再只看自己的数字 |
